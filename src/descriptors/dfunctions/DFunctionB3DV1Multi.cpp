...
namespace visy
{
  namespace descriptors
  {
    ...
    DFunctionB3DV1Multi::DFunctionB3DV1Multi (int n_bins)
    {
      this->size = 3;
      this->signature = new Signature(3, 180.0f, n_bins, true);
    }

    DFunctionB3DV1Multi::~DFunctionB3DV1Multi ()
    {
    }

    void
    DFunctionB3DV1Multi::f (visy::extractors::KeyPoint3D& kp1, visy::extractors::KeyPoint3D& kp2, float** results)
    {
    ...
    std::string
    DFunctionB3DV1Multi::buildStringImpl ()
    {
      return "B3DV1-MULTI";
    }
  }
